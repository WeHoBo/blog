  ...
  <div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden">
      <table class="w-full text-sm">
        ...
        <tbody>
          <tr v-for="u in users" :key="u.id" class="border-t dark:border-gray-700">
            ...
            <td class="px-4 py-3 text-gray-400 text-xs">{{ u.createTime?.substring(0, 10) }}</td>
            <td class="px-4 py-3">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-96">
        ...
        <div class="space-y-3">
          <div>
            ...
            <input v-model="dialogForm.nickname" class="w-full px-3 py-2 border rounded dark:bg-gray-700 dark:border-gray-600 text-sm mt-1" />
          </div>
          <div>
            <label class="text-xs text-gray-400">角色</label>
            <select v-model="dialogForm.role" class="w-full px-3 py-2 border rounded dark:bg-gray-700 dark:border-gray-600 text-sm mt-1">
          ...
          <div>
            ...
            <select v-model="dialogForm.status" class="w-full px-3 py-2 border rounded dark:bg-gray-700 dark:border-gray-600 text-sm mt-1">
          ...
          <div>
            ...
            <input v-model="dialogForm.password" type="text" class="w-full px-3 py-2 border rounded dark:bg-gray-700 dark:border-gray-600 text-sm mt-1" />
          </div>
        </div>
